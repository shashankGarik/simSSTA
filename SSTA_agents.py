...
class SSTAAgents():
    def __init__(self,obstacles,controller,frame_rate,infinity):
        ...
        self.goal_pos = np.array([[1500, 1500,None,None,None,None,None],[1500, 1600,None,None,None,None,None],[1500, 1200,None,None,None,None,None]]) # globalgx,globalgy,goalviewlocalgx,goalviewlocalgy,currlocalviewx,currlocalviewy,view/segment
