...
parser.add_argument('--remove_old_data', type=bool, default=True, help = "Deletes the old data directories and files")
...
parser.add_argument('--inference_duration', type = int, nargs= '+',default = (250,500), help = "(start_frame, end_frame)")

parser.add_argument('--debugging', type = bool, default = False, help ="Show debugging points and view frames(ssta) or not")
parser.add_argument('--enable_ssta_agents', type = bool, default = False, help ="Add in SSTA agents to the APF agents or not")
parser.add_argument('--generate_new_agents', type = bool, default = True, help ="generate/spawn new agents")
parser.add_argument('--display_metric', type = bool, default = False, help ="Displays the metrics when set to True")
parser.add_argument('--display_realistic', type = bool, default = False, help ="Makes the agents with a realistic image")
parser.add_argument('--manual_path_plan_ssta', type = bool, default = True, help ="ssta_agents_follow_manual_path")
parser.add_argument('--global_path_intermediate_points', type = int, default = 10, help ="NEED TO ADD DOC STRING")
parser.add_argument('--replanning_time_interval', type = int, default = 1 ,help ="this is in seconds")###
